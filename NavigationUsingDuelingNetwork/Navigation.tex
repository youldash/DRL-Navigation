...
\makeatother
    ...
    \section{Navigation - Using Dueling Network
(DN)}\label{navigation---using-dueling-network-dn}
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Global configuration.}
        ...
        \PY{n}{TOGGLE\PYZus{}DOUBLE\PYZus{}DQN} \PY{o}{=} \PY{k+kc}{False}           \PY{c+c1}{\PYZsh{} True for the Double\PYZhy{}DQN method. False for the fixed Q\PYZhy{}target method.}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{for} \PY{n}{i\PYZus{}episode} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{n\PYZus{}episodes}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
                ...
                \PY{k}{if} \PY{n}{np}\PY{o}{.}\PY{n}{mean}\PY{p}{(}\PY{n}{scores\PYZus{}window}\PY{p}{)} \PY{o}{\PYZgt{}}\PY{o}{=} \PY{l+m+mf}{13.}\PY{p}{:}
                    ...
                    \PY{n}{torch}\PY{o}{.}\PY{n}{save}\PY{p}{(}\PY{n}{agent}\PY{o}{.}\PY{n}{qnetwork\PYZus{}local}\PY{o}{.}\PY{n}{state\PYZus{}dict}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{models/checkpoint\PYZus{}dn.pth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{} Initialize a DQN agent instance.}
        ...
        \PY{n}{scores}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{dqn}\PY{p}{(}\PY{n}{n\PYZus{}episodes}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mf}{2e3}\PY{p}{)}\PY{p}{,} \PY{n}{max\PYZus{}t}\PY{o}{=}\PY{n+nb}{int}\PY{p}{(}\PY{l+m+mf}{4e2}\PY{p}{)}\PY{p}{,} \PY{n}{eps\PYZus{}start}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}1}\PY{p}{,} \PY{n}{eps\PYZus{}end}\PY{o}{=}\PY{l+m+mf}{1e\PYZhy{}2}\PY{p}{,} \PY{n}{eps\PYZus{}decay}\PY{o}{=}\PY{l+m+mf}{987e\PYZhy{}3}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{} Plot the scores using matplotlib.}
         ...
         \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Rewards \PYZhy{} Using Dueling Network (DN)}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{k}{try}\PY{p}{:}
         ...
         \PY{n}{state\PYZus{}dict} \PY{o}{=} \PY{n}{torch}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{models/checkpoint\PYZus{}dn.pth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
         ...
         \PY{n}{max\PYZus{}t} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{l+m+mf}{4e2}\PY{p}{)}
